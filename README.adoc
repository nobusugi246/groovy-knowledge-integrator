...
Download `gki-chat-1.0.9.jar` from
...
====
----
$ java -jar gki-chat-1.0.9.jar --server.port=8081
----
====
...
* Ver.1.0.9, update support of MessageNumberBadge on each day and reply selection. : 2016-01-12

* Ver.1.0.8, First support of MessageNumberBadge on each day. : 2016-01-10
