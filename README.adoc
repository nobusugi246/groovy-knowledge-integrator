...
====
----
$ java -jar gki-0.1.8.jar --server.port=8081
----
====
...
* Very thanks to Grails and it's ecosystem.
** https://grails.org/

* Very thanks to Jdenticon.
** https://github.com/dmester/jdenticon


== ChangLog / 変更履歴

* Ver.0.1.8, . : 2016-05-24
