...
Download `gki-chat-1.1.0.jar` from
...
====
----
$ java -jar gki-chat-1.1.0.jar
----
====

This will generate 2 Database files (prodDb.mv.db, prodDb.trace.db) at the current folder.
...
====
----
$ java -jar gki-chat-1.1.0.jar --server.port=8081
----
====
...
* Ver.1.1.0, Fix Web Notification, separate Past Messages in a Collapse. : 2017-01-15
