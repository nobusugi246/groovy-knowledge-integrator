...
Download `gki-chat-1.1.9.jar` and `gki-container-0.1.0.jar` from
...
====
----
$ java -jar gki-chat-1.1.9.jar
$ java -jar gki-container-0.1.0.jar
----
====
...
====
----
$ java -jar gki-chat-1.1.9.jar --server.port=8082
----
====
