...
Download `gki-1.0.0-RC2.jar` from
...
====
----
$ java -jar gki-1.0.0-RC2.jar --server.port=8081
----
====
...
* Ver.1.0.0-RC2, Update Icon Image Download. : 2016-08-11
