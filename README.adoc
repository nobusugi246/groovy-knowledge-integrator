...
Download `gki-chat-1.1.13.jar` and `gki-container-0.1.8.jar` from
...
====
----
$ java -jar gki-chat-1.1.13.jar --server.port=8082
----
====
...
* Chat Ver.1.1.13 / Chatbot Ver.0.1.8, . : 2017-09-18
