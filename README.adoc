...
これらの活動が、発生順に、時系列に並べられてチャットとして表示されます。
適宜、ChatRoomを作成して振り分けることで、分類し、見通しを良くできます。


== How to run / 実行方法

Download `gki-0.1.17.jar` from
...
====
----
$ java -jar gki-0.1.17.jar --server.port=8081
----
====
...
* Ver.0.1.17, Update Grails to Ver.3.1.9, Gorm Ver.5.0.10. : 2016-07-03
