...
Download `gki-chat-1.1.8.jar` from
...
====
----
$ java -jar gki-chat-1.1.8.jar --server.port=8081
----
====
...
* Ver.1.1.8, Setup the frontend at startup. : 2017-04-24
