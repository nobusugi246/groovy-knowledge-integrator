...
Download `gki-chat-1.1.19.jar` and `gki-container-0.1.1.jar` from
...
====
----
$ java -jar gki-chat-1.1.10.jar
$ java -jar gki-container-0.1.1.jar
----
====
...
====
----
$ java -jar gki-chat-1.1.10.jar --server.port=8082
----
====
