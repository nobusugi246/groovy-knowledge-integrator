...
Download `gki-chat-1.1.1.jar` from
...
====
----
$ java -jar gki-chat-1.1.1.jar --server.port=8081
----
====
...
* Ver.1.1.1, Remove the horizontal scroll bar, add a Accordion icon. : 2017-01-22
