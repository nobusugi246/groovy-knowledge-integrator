...
<html>
    ...
    <body>
        ...
        <div id="show-chatUser" class="content scaffold-show" role="main">
            ...
            <f:display bean="chatUser" />
            <g:form resource="${this.chatUser}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.chatUser}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
