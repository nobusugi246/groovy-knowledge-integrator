...
<html>
    ...
    <body>
        ...
        <div id="show-chatMessage" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.chatMessage}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.chatMessage}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
