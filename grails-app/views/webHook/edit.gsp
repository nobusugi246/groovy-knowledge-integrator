...
<html>
    ...
    <body>
        ...
        <div id="edit-webHook" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.webHook}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.webHook}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.webHook}" method="PUT">
                <g:hiddenField name="version" value="${this.webHook?.version}" />
                <fieldset class="form">
                    <f:all bean="webHook"/>
                </fieldset>
