...
<html>
    ...
    <body>
        ...
        <div id="show-webHook" class="content scaffold-show" role="main">
            ...
            <f:display bean="webHook" />
            <g:form resource="${this.webHook}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.webHook}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
